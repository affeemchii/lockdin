    ...
    return (
        <s-page>
            <UpgradeModal
                ...
                title="COD reminders are a Pro feature"
                message="Upgrade to Pro to get automated reminders when COD balances are due. Never forget to collect a payment again."
                limitType="reminders"
                billing={billing}
